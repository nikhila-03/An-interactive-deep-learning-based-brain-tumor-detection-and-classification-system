...
model_path1 = 'model_stage1.h5' # load .h5 Model

model_path2 = 'model_stage2.h5' # load .h5 Model
...
def model_predict1(image_path,model):
    ...
    if result == 0:
        return "Patient is  Diagnosis With No Tumor","result.html"        
    elif result == 1:
        return "Patient is  Diagnosis With Tumor","result.html"
...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "Patient is  Diagnosis With Glioma Tumor","result1.html"        
    elif result == 1:
        return "Patient is  Diagnosis With Meningioma Tumor","result1.html"
    elif result == 2:
        return "Patient is  Diagnosis With No Tumor","result1.html"
    elif result == 3:
        return "Patient is  Diagnosis With Pituatary Tumor","result1.html"
...
def predict1():
    ...
    if request.method == 'POST':
        ...
        if int(message) == otp:
            ...
            cur = con.cursor()
            cur.execute("insert into `info` (`email`, `password`,`mobile`,`name`) VALUES (?,?,?,?,?)",(username,email,password,number,name))
            con.commit()
            con.close()
            return render_template("signin.html")
    return render_template("signup.html")
